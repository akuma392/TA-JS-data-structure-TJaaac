...
for (let nam of got.houses[0].people) {
...
// answer 5
for (let nam of got.houses[1].people) {
  console.log(nam.name);
}
...
for (let nam of got.houses[1].people) {
  console.log(`I am ${nam.name} and my bio is ${nam.description}`);
}
